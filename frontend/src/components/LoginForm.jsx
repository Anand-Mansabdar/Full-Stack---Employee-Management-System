  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full animate-fade-in max-w-md">
          <Link
            to={`/login`}
            className="inline-flex items-center gap-2 text-neutral-400 hover:text-neutral-700 text-sm mb-10 transition-colors"
          >
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-neutral-600 transition-all"
